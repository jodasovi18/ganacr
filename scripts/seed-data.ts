...
export function generateSeedData(userId: string) {
  ...
  // Cálculos venta parcial L2 (3 de 8 animales)
  ...
  // VALORES EXACTOS para validación al centavo en calculos.spec.ts
  const l3Animals = [
  ...
  // ─── PESAJES (3 por animal, ganancia de ~20kg/mes) ────────────────────────
  ...
  type VentaDoc = typeof ventaL2 | typeof ventaL3;
