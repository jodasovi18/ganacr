...
export default function GastosFincaTab({
  ...
  if (loading) {
    return (
      <p className="text-center text-muted-foreground py-12">Cargando gastos de finca...</p>
    );
  }
  ...
  if (gastosFinca.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <p className="font-semibold text-foreground mb-1">Sin gastos de finca registrados</p>
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1 flex-wrap">
                  <span className="font-bold text-foreground truncate">{gf.concepto}</span>
              ...
              <div className="flex flex-col items-end gap-2 shrink-0">
                <span className="font-bold text-foreground">{formatColones(gf.montoTotal)}</span>
                <Button
                  variant="ghost"
                  size="icon"
