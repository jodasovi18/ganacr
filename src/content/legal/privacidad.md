...
personales** de Costa Rica y su Reglamento. Esta política explica qué datos tratamos, con qué fin, con
quién los compartimos y cuáles son tus derechos.
...
- **Datos de cuenta:** nombre, correo electrónico y contraseña (los proporcionás al registrarte).
- **Datos de uso del Servicio:** información de fincas, lotes, animales, pesajes, gastos y ventas que
  ingresás vos.
- **Datos de terceros que ingresás:** el nombre de socios en sociedades "a medias".
...
- La **contraseña** se gestiona mediante Firebase Authentication (Google) de forma cifrada;
  **no almacenamos ni vemos tu contraseña en texto claro**.
- Los **registros de errores** se capturan con Sentry y están configurados para **no enviar datos
  personales por defecto**.
- Al ingresar el nombre de un socio, declarás que contás con base legítima para hacerlo.

## 3. Finalidad del tratamiento

Tratamos tus datos para:

1. Prestarte el servicio de gestión ganadera.
...
- **Google Firebase** (Firestore, Authentication, App Check): almacenamiento de datos y autenticación.
- **Vercel:** alojamiento de la aplicación web.
- **Sentry:** monitoreo de errores.

**Transferencia internacional:** estos proveedores procesan y almacenan datos en servidores **fuera de
Costa Rica** (por ejemplo, en Estados Unidos). Al usar el Servicio, consentís dicha transferencia. Cada
proveedor mantiene sus propias medidas de seguridad y cumplimiento.
...
sección 8. Por seguridad, los datos pueden permanecer en **copias de respaldo** por un tiempo limitado
antes de ser sobrescritas.
...
- **Aislamiento por usuario** a nivel de base de datos: cada persona usuaria solo accede a **sus**
  datos.
- **Control anti-abuso** (App Check) contra accesos automatizados.
...
de los Habitantes (PRODHAB)**, órgano competente en Costa Rica.
