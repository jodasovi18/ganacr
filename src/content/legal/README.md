...
2. **Completar los `[corchetes]`:** nombre/razón social del titular, identificación, domicilio,
   correo de contacto de privacidad y fechas de vigencia. Mientras no se completen, los usuarios
   verán literalmente `[corchetes]` en las páginas.
