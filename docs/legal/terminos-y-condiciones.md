...
- Tu retroalimentación es bienvenida y podrá usarse para mejorar el Servicio.

## 3. Cuenta de usuario

- Debés ser **mayor de edad** y proporcionar información **veraz** al registrarte.
- Sos responsable de la **confidencialidad de tus credenciales** y de toda actividad realizada con tu
...
- **Cumplimiento legal propio:** GanaCR es una **herramienta de apoyo** y **no sustituye** tus
  obligaciones ni los trámites oficiales ante **SENASA** (areteo, movilización), las autoridades
  **tributarias**, el **MAG** u otras entidades. Cumplir dichas obligaciones es tu responsabilidad.
- **Datos de terceros:** si ingresás datos de terceros (por ejemplo, el nombre de un socio), declarás
  contar con base legítima para hacerlo.

## 6. Naturaleza de los cálculos y reportes
...
Procuramos mantener el Servicio disponible, pero **no garantizamos** un funcionamiento ininterrumpido
ni libre de errores, especialmente durante la fase beta. Podemos realizar mantenimientos o cambios.

## 9. Limitación de responsabilidad

En la máxima medida permitida por la ley costarricense, **no seremos responsables** por daños
indirectos, incidentales, lucro cesante, ni por pérdida de datos o de utilidades derivados del uso o
imposibilidad de uso del Servicio. Nada en estos Términos limita responsabilidades que no puedan
excluirse legalmente.

## 10. Privacidad

El tratamiento de tus datos personales se rige por nuestra **Política de Privacidad**, que forma parte
integral de estos Términos.

## 11. Suspensión y terminación

Podés dejar de usar el Servicio y solicitar la eliminación de tu cuenta en cualquier momento. Podemos
suspender o cancelar cuentas que incumplan estos Términos o ante requerimientos legales.

## 12. Modificaciones

Podemos modificar estos Términos. Publicaremos la versión vigente con su fecha y, ante cambios
sustanciales, te lo notificaremos por un medio razonable. El uso continuado del Servicio implica la
...
someterá a los tribunales competentes de Costa Rica, sin perjuicio de los derechos que la ley de
protección al consumidor reconozca a las personas usuarias.
